...
module NLHue
	...
	#
	# TODO: Much code is shared with Group; consolidate into a Target
	# superclass.
	class Light
		attr_reader :id, :type, :name, :bridge
		...
		# not be sent to the light until #submit is called.  Call
		...
		# Tells the Bridge object that this Light is ready to have its
		...
		def submit &block
			puts "Submitting changes to light #{self}" # XXX
